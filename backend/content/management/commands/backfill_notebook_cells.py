        ...
        for notebook in notebooks:
            ...
            for idx, cell in enumerate(data['cells']):
                ...
                for output in outputs:
                    ...
                    if out_type == 'stream':
                        ...
                        if image_mime:
                            ...
                            try:
                                ...
                                # Create a custom file wrapper to provide content_type
                                class SupabaseFile:
                        ...
                        # Also capture text/plain or text/html as text_output
                    ...
                    if text_out or error_out or image_out or html_out:
                        # Use update_or_create to avoid UniqueViolation on cell_id
