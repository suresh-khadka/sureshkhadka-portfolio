  ...
  return (
    <div className="page-container">
      ...
      <section className="flex flex-col items-center text-center py-20">
        ...
        <p className="text-lg md:text-xl text-text_muted max-w-2xl mx-auto mb la-10">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {featuredProjects.map(project => (
              <div key={project.id} className="group bg-secondary rounded-2xl overflow-hidden border border-slate-700 hover:border-accent transition-all duration-300 shadow-xl">
                ...
                <div className="p-6">
                  ...
                  <Link 
                    ...
                    className="text-white font-semibold flex items-center gap-2 group-hover:text-accent transition-colors"
                  >
