  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div className="lg:col-span-2 space-y-4">
        {links.map(l => (
          <div key={l.id} className="bg-secondary p-4 rounded-xl border border-slate-200 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="text-text-main font-bold">{l.platform}</div>
            ...
            <div className="flex gap-2">
              ...
              <Button variant="outline" className="px-3 py-1 text-xs text-red-400 border-red-400 hover:bg-red-400 hover:text-text-main" onClick={() => handleDelete(l.id)}>Delete</Button>
            </div>
          </div>
        ))}
      </div>
